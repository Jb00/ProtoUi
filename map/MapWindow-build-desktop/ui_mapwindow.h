...
**
** Created: Wed Jan 26 15:37:53 2011
...
public:
    ...
    void setupUi(QMainWindow *MapWindow)
    {
        ...
        label_img->setGeometry(QRect(20, 20, 911, 491));
        ...
        menuFuck_you = new QMenu(menuBar);
        menuFuck_you->setObjectName(QString::fromUtf8("menuFuck_you"));
        MapWindow->setMenuBar(menuBar);

        menuBar->addAction(menuFile->menuAction());
        menuBar->addAction(menuView->menuAction());
        menuBar->addAction(menuFuck_you->menuAction());
        ...
        menuFuck_you->addAction(actionAdd_newUser);
        menuFuck_you->addAction(actionDelete_User);
        menuFuck_you->addSeparator();
        menuFuck_you->addAction(actionCreate_Facility);
        menuFuck_you->addAction(actionDelete_Facility);
    ...
    void retranslateUi(QMainWindow *MapWindow)
    {
        ...
        menuControl_Panel->setTitle(QApplication::translate("MapWindow", "Control Panel", 0, QApplication::UnicodeUTF8));
        ...
        menuFuck_you->setTitle(QApplication::translate("MapWindow", "Admin", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
