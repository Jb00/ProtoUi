...
**
** Created: Thu Jan 27 13:22:27 2011
...
public:
    ...
    void setupUi(QMainWindow *FacilityWindow)
    {
        ...
        layoutWidget4->setGeometry(QRect(290, 200, 156, 128));
        ...
        widget->setGeometry(QRect(450, 231, 205, 62));
        ...
        textAdd = new QLineEdit(widget);
        textAdd->setObjectName(QString::fromUtf8("textAdd"));

        formLayout->setWidget(0, QFormLayout::FieldRole, textAdd);
        ...
        textAssign = new QLineEdit(widget);
        textAssign->setObjectName(QString::fromUtf8("textAssign"));

        formLayout->setWidget(1, QFormLayout::FieldRole, textAssign);
    ...
    void retranslateUi(QMainWindow *FacilityWindow)
    {
        ...
        label_5->setText(QApplication::translate("FacilityWindow", "How many", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("FacilityWindow", "How many", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
